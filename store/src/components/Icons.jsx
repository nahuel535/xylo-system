...
export function XyloLogo({ size = 28 }) {
  return (
    <img
      src={logo}
      alt="Xylo"
...
export function BatteryIcon({ size = 24, color = "currentColor" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
      ...
      <polyline points="6 11 8 11 8 13 6 13 6 11" fill={color} stroke="none" />
      <polyline points="10 11 12 11 12 13 10 13 10 11" fill={color} stroke="none" />
...
export function BoxIcon({ size = 24, color = "currentColor" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
...
export function PhoneIcon({ size = 64, color = "#ccc" }) {
  return (
